...
// 🧑‍🎨 작가 대시보드 컴포넌트
function ArtistDashboard({ activeIndex, containerRef, itemRefs }: { activeIndex: number; containerRef: any; itemRefs: any; }) {
  return (
    <>
      {/* 내 작품 */}
      <section>
...
// 🏬 사장님 대시보드 컴포넌트
function ManagerDashboard({ activeIndex, containerRef, itemRefs }: { activeIndex: number; containerRef: any; itemRefs: any; }) {
  return (
    <>
      {/* 내 가게 */}
      <section>
