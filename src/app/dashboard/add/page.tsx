      ...
      <div className="relative flex min-h-screen flex-col overflow-x-hidden">
        ...
        <main className="flex-1 p-4 space-y-6">
          <form className="space-y-6" onSubmit={handleSubmit}>
            {/* 작품명 */}
            <div>
              <label className="input-label" htmlFor="artwork-name">
                작품명
              </label>
              <input
                id="artwork-name"
            ...
            <div>
              ...
              <div className="grid grid-cols-2 gap-4">
                <div>
                  <label className="text-xs text-[var(--text-secondary)]" htmlFor="height">
                    세로
                  </label>
                ...
                <div>
                  <label className="text-xs text-[var(--text-secondary)]" htmlFor="width">
                    가로
                  </label>
                  <div className="relative mt-1">
                    <input
              ...
              <div className="flex">
                ...
                <div className="ml-3">
                  ...
                  <div className="mt-2 text-sm text-[var(--text-secondary)]">
                    <p>
                      액자나 케이스가 포함된다면 그 크기까지 포함해 가능한 한 정확한
                      가로·세로 치수를 입력해 주세요.
                    </p>
                  </div>
                </div>
