  ...
  return (
    <footer className="fixed bottom-0 left-0 w-full bg-white/90 backdrop-blur-sm border-t border-gray-100 z-50">
      <nav className="flex justify-around items-center h-16">
        <Link
          className="flex flex-col items-center justify-center gap-1 text-[#8C7853]"
          href="#"
        >
        ...
        <Link
          className="flex flex-col items-center justify-center gap-1 text-[#D2B48C] font-bold"
          href="/bookingday"
        >
          <svg fill="currentColor" height="24" width="24" viewBox="0 0 256 256">
        ...
        >
          ...
          <p className="text-xs font-medium">내 정보</p>
        </Link>
      </nav>
    </footer>
  );
