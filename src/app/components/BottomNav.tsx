    ...
    >
      <nav className="flex justify-around items-center h-16">
        <Link className={linkCls('/home')} href="/home">
          ...
          <p className={textCls('/home')}>홈</p>
        </Link>

        <Link className={linkCls('/bookingdate2')} href="/bookingdate2">
          <svg fill="currentColor" height="24" width="24" viewBox="0 0 256 256">
            <path d="M229.66,218.34l-50.07-50.06a88.11,88.11,0,1,0-11.31,11.31l50.06,50.07a8,8,0,0,0,11.32-11.32ZM40,112a72,72,0,1,1,72,72A72.08,72.08,0,0,1,40,112Z"></path>
          </svg>
          <p className={textCls('/bookingdate2')}>예약</p>
        </Link>
        ...
        <Link className={linkCls('/dashboard')} href="/dashboard">
          ...
          <p className={textCls('/dashboard')}>대시보드</p>
        </Link>
