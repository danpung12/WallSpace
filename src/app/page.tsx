  ...
  return (
    <div>
      ...
      <style>{`
        ...
        .input-field {
          width: 100%; height: 3rem; background: var(--input-bg); border-radius: 0.5rem; color: var(--text-primary);
          padding-left: 1rem; font-size: 0.95rem; font-weight: 400; border: 1px solid #e5e7eb; transition: all 0.3s;
          box-shadow: 0 1px 2px 0 rgba(16, 24, 40, 0.04);
        }
        .input-field:focus { outline: none; border-color: var(--primary-color); box-shadow: 0 0 0 3px rgba(193, 154, 107, 0.18); }
        .input-field::placeholder { color: var(--input-placeholder); opacity: 1; }
        .primary-button {
          width: 100%; height: 3rem; background: var(--primary-color); color: var(--white); font-size: 1rem;
        ...
        .secondary-button {
          width: 100%; height: 3rem; background: transparent; color: var(--primary-color); border: 1px solid var(--primary-color);
        ...
        <div className="relative flex flex-col min-h-screen justify-center px-6 md:px-8 py-12 md:py-16">
          ...
          >
            <div className="text-center mb-8">
              <h2 className="text-2xl md:text-3xl font-bold tracking-tight" style={{ color: 'var(--text-primary)' }}>로그인</h2>
            </div>
            <form className="space-y-4" onSubmit={handleLogin}>
              ...
              <div className="text-right py-1">
                <a className="text-[12px] sm:text-[13px] hover:underline" style={{ color: 'var(--text-secondary)' }} href="/find-password">비밀번호를 잊으셨나요?</a>
              </div>
            ...
            <div className="mt-8 flex items-center">
              ...
              <span className="flex-shrink mx-4 text-[11px] sm:text-xs" style={{ color: 'var(--text-secondary)' }}>간편 로그인</span>
              <div className="flex-grow" style={{ borderTop: '1px solid #d1d5db' }} />
            </div>
