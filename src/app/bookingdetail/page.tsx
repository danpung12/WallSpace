    ...
    <>
      ...
      <header className="fixed top-0 left-0 right-0 z-20 bg-[var(--background-color)]/80 backdrop-blur-sm">
          <div className="flex items-center justify-between p-4">
            <button onClick={onBack} className="text-[var(--text-primary)]" aria-label="Back">
              <svg
            ...
            <h1 className="text-xl font-bold text-[var(--text-primary)]">예약 상세정보</h1>
            <div className="w-7" />
          </div>
        </header>
        ...
        <main className="flex-1 p-4 space-y-6 pt-16">
          ...
          {/* Artwork */}
          <section className="bg-white rounded-xl shadow-sm p-6">
            <h3 className="text-lg font-bold text-[var(--text-primary)] mb-4">작품 정보</h3>
            <div className="flex items-start gap-4">
              ...
              <div className="flex-1 space-y-1">
                ...
                <p className="text-sm text-[var(--text-secondary)]">by {booking.artwork.artist}</p>
                <p className="text-sm text-[var(--text-secondary)]">사이즈: {booking.artwork.size}</p>
              </div>
            </div>
          </section>
          ...
          {/* Space */}
          <section className="bg-white rounded-xl shadow-sm p-6">
            <h3 className="text-lg font-bold text-[var(--text-primary)] mb-4">예약 장소</h3>
            <div className="flex items-start gap-4">
              <div
                className="w-24 h-24 bg-center bg-no-repeat bg-cover rounded-lg flex-shrink-0"
              ...
              <div className="flex-1 space-y-1">
                ...
                <p className="text-sm text-[var(--text-secondary)]">{booking.space.venue}</p>
          ...
          {/* Period */}
          <section className="bg-white rounded-xl shadow-sm p-6">
            <h3 className="text-lg font-bold text-[var(--text-primary)] mb-4">예약 기간</h3>
            <div className="space-y-3">
              <div className="flex items-center justify-between">
                <p className="text-sm font-medium text-[var(--text-secondary)]">시작일</p>
                <p className="text-base font-semibold text-[var(--text-primary)]">
                  {fmtDate(booking.period.start)}
                </p>
              </div>
              <div className="flex items-center justify-between">
                <p className="text-sm font-medium text-[var(--text-secondary)]">종료일</p>
                <p className="text-base font-semibold text-[var(--text-primary)]">
                  {fmtDate(booking.period.end)}
                </p>
              </div>
              <div className="flex items-center justify-between">
                <p className="text-sm font-medium text-[var(--text-secondary)]">기간</p>
                <p className="text-base font-semibold text-[var(--text-primary)]">
                  {durationDays} Days
                </p>
              </div>
          ...
          {/* Cost */}
          <section className="bg-white rounded-xl shadow-sm p-6">
            <h3 className="text-lg font-bold text-[var(--text-primary)] mb-4">비용 요약</h3>
            <div className="space-y-2">
              <div className="flex items-center justify-between">
                ...
                <p className="text-sm text-[var(--text-primary)]">
                  ₩{booking.pricing.dailyRate.toFixed(2)} x {durationDays} 일
                </p>
              </div>
              <div className="flex items-center justify-between">
              ...
              <div className="flex items-center justify-between">
                <p className="text-base font-bold text-[var(--text-primary)]">총 비용</p>
