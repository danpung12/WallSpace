                          ...
                          >
                            ...
                            {isEditing ? (
                              ...
                              <>
                                ...
                                {/* 모바일: 예약 현황을 오른쪽 상단에 배치 */}
                                {!isEditing && (
                                  <div className="sm:hidden absolute top-4 right-4 px-3 py-2 rounded-lg flex items-center gap-1.5 text-xs bg-white border border-[#D2B48C] shadow-md z-10">
                                    {isCountLoading || currentReservations === undefined || maxArtworks === undefined ? (
                                      <div className="flex items-center gap-1.5">
                                        <div className="w-3 h-3 border-2 border-[#D2B48C] border-t-transparent rounded-full animate-spin"></div>
                                        <span className="font-semibold text-[#3D2C1D] dark:text-gray-100">로딩 중...</span>
                                      </div>
                                    ) : (
                                      <>
                                        <svg className="w-4 h-4 text-[#D2B48C] flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                          <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M17 20h5v-2a3 3 0 00-5.356-1.857M17 20H7m10 0v-2c0-.656-.126-1.283-.356-1.857M7 20H2v-2a3 3 0 015.356-1.857M7 20v-2c0-.656.126-1.283.356-1.857m0 0a5.002 5.002 0 019.288 0M15 7a3 3 0 11-6 0 3 3 0 016 0zm6 3a2 2 0 11-4 0 2 2 0 014 0zM7 10a2 2 0 11-4 0 2 2 0 014 0z" />
                                        </svg>
                                        <div className="flex items-center gap-0.5 font-semibold text-[#3D2C1D] dark:text-gray-100">
                                          <span className={`${currentReservations >= maxArtworks ? 'text-red-500' : 'text-[#D2B48C]'}`}>
                                            {currentReservations}
                                          </span>
                                          <span className="text-gray-400 mx-0.5">/</span>
                                          <span>{maxArtworks}</span>
